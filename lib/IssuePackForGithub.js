...
var IssuePackForGithub = function () {
  //Set initial options and logger
  function IssuePackForGithub(options) {
    var logger = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : console;

    _classCallCheck(this, IssuePackForGithub);
  ...
  _createClass(IssuePackForGithub, [{
    key: 'load',
    ...
    value: function push(repo) {
      var milestoneNumber = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
